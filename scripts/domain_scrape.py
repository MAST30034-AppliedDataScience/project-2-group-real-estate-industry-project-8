...
def random_delay():
    time.sleep(random.uniform(1, 1.5))  # Random delay between 1 to 1.5 seconds
...
def is_error_page(bs_object):
    ...
    # Additional checks for other error conditions can be added here
    return False
...
# Extract the keys (which are the object names) and put them into a list
